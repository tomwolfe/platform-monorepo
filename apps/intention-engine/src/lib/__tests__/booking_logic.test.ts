...
describe("Restaurant Booking Architecture", () => {
  describe("MCP Discovery Pattern", () => {
    ...
    // Skipped: booking.ts module was removed, tests no longer applicable
    it.skip("should throw error if deprecated mock functions are called", async () => {
  ...
  describe("Tool Registry", () => {
    // Skipped: Requires @repo/shared mocking which causes ServiceNamespace errors
    it.skip("should not contain fake booking tools in registry", async () => {
