...
export default function ReservationForm({
  ...
  if (successId) {
    return (
      ...
      >
        ...
        <h2 className="text-2xl font-bold" data-testid="success-title">
          Confirmed!
        </h2>
  ...
  return (
    ...
    >
      {error && (
        <div
          className="p-4 bg-red-50 border border-red-100 rounded-xl flex gap-3 text-red-800 text-sm"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="space-y-6">
          <div
            className="flex flex-col items-center border rounded-2xl p-4 bg-white shadow-sm"
          ...
          <div
            ...
            data-testid="guest-details-section"
          >
        ...
        <div className="space-y-6">
          <div data-testid="party-size-section">
          ...
          <div className="pt-4">
            ...
            <p className="text-center text-xs text-gray-400 mt-4">
              By clicking confirm, you agree to the restaurant&apos;s terms of
              service.
            </p>
          </div>
        </div>
